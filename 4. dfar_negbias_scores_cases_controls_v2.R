...
# BFRT
summary(asian_controls$benton.total)
summary(asian_cases$benton.total)
...
# BFRT
summary(white_controls$benton.total)
summary(white_cases$benton.total)
...
# BFRT
summary(black_controls$benton.total)
summary(black_cases$benton.total)
...
# BFRT
summary(mixed_controls$benton.total)
summary(mixed_cases$benton.total)
...
# BFRT
summary(northafrican_controls$benton.total)
summary(northafrican_cases$benton.total)
