...
# Processing speed descriptives

# Black 
data_black <- read.csv("data_black_filtered_sensitivity_analysis_v2.csv")
names(data_black)
table(data_black$group_black)
...
summary(black_controls$symbol_coding_scaled)
summary(black_cases$symbol_coding_scaled)


# Asian
data_asian <- read.csv("data_asian_filtered_sensitivity_analysis_v2.csv")
names(data_asian)
...
summary(asian_controls$symbol_coding_scaled)
summary(asian_cases$symbol_coding_scaled)
...
summary(white_controls$symbol_coding_scaled)
summary(white_cases$symbol_coding_scaled)

# Mixed 

data_mixed <- read.csv("data_mixed_filtered_sensitivity_analysis.csv")
names(data_mixed)
table(data_mixed$group_mixed)
...
summary(mixed_controls$symbol_coding_scaled)
summary(mixed_cases$symbol_coding_scaled)


# North african  

data_northafrican <- read.csv("data_northafrican_filtered_sensitivity_analysis_v2.csv")
names(data_northafrican)
table(data_northafrican$group_northafrican)
...
summary(northafrican_controls$symbol_coding_scaled)
summary(northafrican_cases$symbol_coding_scaled)


# Other 

data_other <- read.csv("data_other_filtered_sensitivity_analysis.csv")
names(data_other)
table(data_other$group_other)
...
summary(other_controls$symbol_coding_scaled)
summary(other_cases$symbol_coding_scaled)
...
# BFRT
summary(other_controls$benton.total)
summary(other_cases$benton.total)
